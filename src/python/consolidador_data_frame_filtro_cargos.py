...
class ConsolidadorDataFrame:
    ...
    def filtrar_dataframe (self, caminho_arquivo_csv, codificacao='iso-8859-1', separador=';'):
    ...
    def percorre_diretorio_CSV(self, diretorio, texto_filtro_arquivo, caminho_destino_csv, tamanho_bloco=12, codificacao='iso-8859-1', separador=';', ano_inicio=None):
        ...
        for subdiretorio in subdiretorios_ordenados:
            ...
            if (ano_inicio == None) or (ano_subdiretorio >= ano_inicio):
                ...
                if len(lista_arquivo) == 1:
                    ...
                    df_total = self.filtrar_dataframe (caminho_completo_arquivo_csv, codificacao, separador)

export class LinkExemplo extends HTMLElement{
    ...
    constructor(){
        ...
        <header class="br-header mb-4" id="header" data-sticky="data-sticky" style="position: sticky; display: block;">
            <div class="container-lg">
              <div class="header-top">
                <div class="header-logo"><img src="./img/receita-federal-logo.png" alt="logo"/>
                ...
                <div class="header-actions">
                  <div class="header-links dropdown">
                    ...
                    <div class="br-list">
                      ...
                      </div><a class="br-item" href="javascript:void(0)">Link de acesso 1</a><a class="br-item" href="javascript:void(0)">Link de acesso 2</a><a class="br-item" href="https://portaldatransparencia.gov.br/">Portal da Transparência</a><a class="br-item" href="javascript:void(0)">Link de acesso 4</a>
                    </div>
              ...
              <div class="header-bottom">
                <div class="header-menu mt-3">
                  ...
                  <div class="header-info">
                    <div class="header-title">Programa de Estágio</div>
                    <!--- <div class="header-subtitle">Receita Federal do Brasil</div> --->
                  </div>
                </div>
                <div class="header-info mt-3">
                  <button class="br-button" type="button">A RFB
                  </button>
                  <button class="br-button" type="button">O Programa de Estágio
                  </button>
                  <button class="br-button" type="button">Conheça o projeto
                  </button>
                </div>
              </div>
            </div>
